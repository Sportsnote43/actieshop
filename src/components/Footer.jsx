const navigation = {
  solutions: [
    { name: 'Cecotec', href: '/cecotec' },
    { name: 'Jumbo', href: '/jumbo' },
    { name: 'Ridd', href: '/ridd' },
    { name: 'Qware', href: '/qware' },
  ],
  support: [
    { name: 'Algemene Voorwaarden', href: '/algemene_voorwaarden' },
    { name: 'Contact', href: '/contact' },
    { name: 'Privacy Statment', href: '/privacy_statement' },
    ...
    <footer className="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-4">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-white">Merken</h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-white">Bedrijf</h3>
                <ul role="list" className="mt-4 space-y-4">
        ...
        <div className="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
            <h3 className="text-base font-medium text-white">Inschrijven voor nieuwsbrief</h3>
            <p className="mt-2 text-base text-gray-300">
              Het laatste nieuws, artikelen en bronnen, wekelijks naar uw inbox gestuurd.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
            &copy; 2022 The Matching Company B.V., Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
