...
export function Usps() {
  return (
    <div className="bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl divide-y divide-white lg:flex lg:justify-center lg:divide-y-0 lg:divide-x lg:py-8">
        {perks.map((perk, perkIdx) => (
          <div key={perkIdx} className="py-8 lg:w-1/3 lg:flex-none lg:py-0">
            <div className="mx-auto flex max-w-xs items-center px-4 lg:max-w-none lg:px-8">
              <perk.icon className="h-8 w-8 flex-shrink-0 text-white" aria-hidden="true" />
              <div className="ml-4 flex flex-auto flex-col-reverse">
                <h3 className="font-medium text-white">{perk.name}</h3>
